...
<body>
  <header class="topbar" id="adminTopbar" style="display:none">
    <div class="brand">
      <div class="logo"><img src="assets/bioglow-logo.png?v=20260622-final-definitivo" alt="BIOGLOW"></div>
      <div>
  ...
  <script type="module" src="admin.js?v=20260622-final-definitivo"></script>
</body>
</html>
